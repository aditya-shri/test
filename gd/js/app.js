...
function file_video(path,fname) {
	...
	var rname = decodeURI(this.window.location.href.substring(window.location.href.lastIndexOf('/',window.location.href.lastIndexOf('/')+1))).replace('/','').replace('?a=view','');
	var adi = fid.rname.id;
	const content = `
  <div class="container"><br>
  <div class="card">
